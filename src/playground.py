...
complete_nfa1 = AutomataConverter(coefs, 2, 'equal', mask1)
complete_nfa2 = AutomataConverter(coefs, 5, 'equal', mask2)
partial_nfa1 = AutomataConverter(coefs, 2, 'equal', mask1, create_all=False)
partial_nfa2 = AutomataConverter(coefs, 5, 'equal', mask2, create_all=False)
