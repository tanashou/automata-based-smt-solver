...
class SMTLIBv2Visitor(ParseTreeVisitor):
    ...
    def visitCmd_getUnsatAssumptions(self, ctx:SMTLIBv2Parser.Cmd_getUnsatAssumptionsContext):
        return self.visitChildren(ctx)
    ...
    def visitGet_assertions_response(self, ctx:SMTLIBv2Parser.Get_assertions_responseContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SMTLIBv2Parser#get_assignment_response.
    def visitGet_assignment_response(self, ctx:SMTLIBv2Parser.Get_assignment_responseContext):
        return self.visitChildren(ctx)
    ...
    def visitGet_unsat_assump_response(self, ctx:SMTLIBv2Parser.Get_unsat_assump_responseContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SMTLIBv2Parser#get_unsat_core_response.
    def visitGet_unsat_core_response(self, ctx:SMTLIBv2Parser.Get_unsat_core_responseContext):
        return self.visitChildren(ctx)
    ...
    def visitSpecific_success_response(self, ctx:SMTLIBv2Parser.Specific_success_responseContext):
        return self.visitChildren(ctx)
