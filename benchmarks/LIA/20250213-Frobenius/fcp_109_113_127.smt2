...
(declare-fun P () Int)
(assert (and (<= 0 P) (forall ((x0 Int) (x1 Int) (x2 Int)) (=> (and (<= 0 x0) (<= 0 x1) (<= 0 x2)) (not (= (+ (* x0 109) (* x1 113) (* x2 127)) P)))) (forall ((R Int)) (=> (forall ((x0 Int) (x1 Int) (x2 Int)) (=> (and (<= 0 x0) (<= 0 x1) (<= 0 x2)) (not (= (+ (* x0 109) (* x1 113) (* x2 127)) R)))) (<= R P)))))
(check-sat)
(exit)
