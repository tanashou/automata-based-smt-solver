...
(declare-fun P () Int)
(assert (and (<= 0 P) (forall ((x0 Int) (x1 Int) (x2 Int)) (=> (and (<= 0 x0) (<= 0 x1) (<= 0 x2)) (not (= (+ (* x0 11) (* x1 13) (* x2 17)) P)))) (forall ((R Int)) (=> (forall ((x0 Int) (x1 Int) (x2 Int)) (=> (and (<= 0 x0) (<= 0 x1) (<= 0 x2)) (not (= (+ (* x0 11) (* x1 13) (* x2 17)) R)))) (<= R P)))))
(check-sat)
(exit)
